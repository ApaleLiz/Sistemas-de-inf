// Calcula el promedio de tre calificaciones, calcula tambien la mayor y la menor 

float cal1, cal2, cal3, suma, prom, mayor, menor;

Console.WriteLine("Calcula el promedio de tre calificaciones, calcula tambien la mayor y la menor ");
